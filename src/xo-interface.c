...
create_winMain (void)
{
  ...
  GtkWidget *optionsLargePenCursor;
  ...
  optionsLargePenCursor = gtk_check_menu_item_new_with_mnemonic (_("_Large pen cursor"));
  gtk_widget_show (optionsLargePenCursor);
  gtk_container_add (GTK_CONTAINER (menuOptions_menu), optionsLargePenCursor);
  ...
  g_signal_connect ((gpointer) optionsPressureSensitive, "activate",
                    ...
                    NULL);
  g_signal_connect ((gpointer) optionsLargePenCursor, "activate",
                    G_CALLBACK (on_optionsLargePenCursor_activate),
                    NULL);
  ...
  GLADE_HOOKUP_OBJECT (winMain, optionsLargePenCursor, "optionsLargePenCursor");
